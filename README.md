...
- Replies use Telegram rich messages with GitHub-compatible Markdown, including headings, lists, links, quotations, inline code, fenced code blocks, and tables.
