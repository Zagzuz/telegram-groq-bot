...
impl Config {
    pub fn from_env() -> anyhow::Result<Self> {
        ...
        let config = Self {
            ...
            primary_answer_max_tokens: optional("PRIMARY_ANSWER_MAX_TOKENS", 800_u32)?,
            fallback_answer_max_tokens: optional("FALLBACK_ANSWER_MAX_TOKENS", 500_u32)?,
